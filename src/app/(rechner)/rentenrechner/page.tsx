...
const FAQS = [
  { question: 'Wie berechnet sich die gesetzliche Rente?', answer: 'Die Monatsrente ergibt sich aus: Entgeltpunkte × Zugangsfaktor × aktueller Rentenwert. Pro Jahr, in dem Sie das Durchschnittseinkommen verdienen, erhalten Sie 1 Entgeltpunkt. Der aktuelle Rentenwert beträgt 40,79 € (bundeseinheitlich) und steigt zum 01.07.2026 auf 42,52 €.' },
  ...
  { question: 'Wie viel Rente bekomme ich mit 45 Beitragsjahren?', answer: 'Mit 45 Beitragsjahren und Durchschnittseinkommen sammeln Sie 45 Entgeltpunkte. Bei einem Rentenwert von 40,79 € ergibt das ca. 1.836 € brutto/Monat (ab 01.07.2026: 42,52 € bzw. ca. 1.913 €). Davon gehen noch Kranken- und Pflegeversicherungsbeiträge (ca. 11%) ab.' },
  { question: 'Muss ich auf meine Rente Steuern zahlen?', answer: 'Ja, Renten sind steuerpflichtig. Der steuerpflichtige Anteil hängt vom Rentenbeginn ab: bei Rentenbeginn 2026 sind 84% der Rente steuerpflichtig (steigt um 0,5 Prozentpunkte pro Jahr, 100% ab Rentenbeginn 2058). Ob tatsächlich Steuer anfällt, hängt vom Grundfreibetrag ab.' },
      ...
      guideContent={
        <section className="space-y-4">
          ...
          <p className="text-text-secondary leading-relaxed">
            ...
            Jeder dieser drei Faktoren ist beeinflussbar. Der Rentenwert ist politisch gesetzt (40,79 €, ab 01.07.2026: 42,52 €), die
