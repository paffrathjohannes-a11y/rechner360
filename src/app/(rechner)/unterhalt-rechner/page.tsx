...
const FAQS = [
  ...
  { question: 'Wird Kindergeld auf den Unterhalt angerechnet?', answer: 'Ja. Bei minderjährigen Kindern wird das hälftige Kindergeld (129,50 €) vom Tabellenunterhalt abgezogen. Bei volljährigen Kindern wird das volle Kindergeld (259 €) angerechnet. Der verbleibende Betrag ist der Zahlbetrag.' },
      ...
      guideContent={
        <section className="space-y-4">
          ...
          <ul className="space-y-2 text-text-secondary">
            <li><strong>Minderjährige Kinder:</strong> Das <em>hälftige</em> Kindergeld (129,50 €) wird vom Tabellenunterhalt abgezogen. Grund: Beide Elternteile teilen sich die Bar- und Betreuungsunterhalts-Pflicht.</li>
            <li><strong>Volljährige Kinder (Ausbildung / Studium):</strong> Das <em>volle</em> Kindergeld (259 €) wird angerechnet — sie sind selbst Empfänger des Kindergelds, das auf ihren Unterhaltsanspruch angerechnet wird.</li>
          </ul>
          ...
          <p className="text-text-secondary leading-relaxed">
            ...
            Erwerbstätigen, 1.200 € bei Nicht-Erwerbstätigen (Stand Düsseldorfer Tabelle 2026). Reicht das
