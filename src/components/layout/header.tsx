...
import { RECHNER, SITE_NAME } from '@/lib/utils/constants';
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-surface/80 backdrop-blur-lg">
      <nav className="mx-auto flex h-16 max-w-[var(--container-max)] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="md:hidden flex h-9 w-9 items-center justify-center rounded-lg text-text-secondary hover:text-text hover:bg-surface-raised transition-colors cursor-pointer"
      ...
      {/* Mobile Nav */}
      {mobileOpen && (
        <div className="md:hidden border-t border-border bg-surface animate-result-in">
