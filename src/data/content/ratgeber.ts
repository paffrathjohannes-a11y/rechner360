...
export const RATGEBER_CURATED: RatgeberArtikel[] = [
  ...
  },
  {
    ...
    title: 'Grundsicherung und Hinzuverdienst — Freibeträge 2026',
    metaTitle: 'Grundsicherung Hinzuverdienst 2026 — Freibeträge & Anrechnung',
    metaDescription: 'Wie viel darf man zur Grundsicherung (ehem. Bürgergeld) hinzuverdienen? Freibeträge, Anrechnungsregeln und Beispielrechnungen.',
    intro: 'Wer Grundsicherung (ehemals Bürgergeld) bezieht, darf hinzuverdienen — aber nicht alles behalten. Die Freibetragsregelung bestimmt, wie viel vom Verdienst anrechnungsfrei bleibt.',
    sections: [
      ...
      { title: 'Beispielrechnung: 800 € Minijob', content: 'Bei 800 € Bruttoeinkommen: Grundfreibetrag 100 € + 20% von 420 € (100-520) = 84 € + 30% von 280 € (520-800) = 84 €. <strong>Freibetrag: 268 €</strong>. Anrechenbares Einkommen: 532 €. Die Grundsicherung wird um 532 € gekürzt, Sie behalten 268 € zusätzlich zur reduzierten Leistung.' },
  ...
  {
    slug: 'grundsicherung-2026',
    title: 'Neue Grundsicherung ab Juli 2026 — Was sich ändert',
    metaTitle: 'Neue Grundsicherung 2026 — Alle Änderungen gegenüber Bürgergeld',
    metaDescription: 'Ab 01.07.2026 ersetzt die Neue Grundsicherung das Bürgergeld. Verschärfte Vermögensprüfung, strengere Sanktionen — alle Änderungen im Überblick.',
    intro: 'Am 1. Juli 2026 tritt die Neue Grundsicherung in Kraft und löst das bisherige Bürgergeld ab. Die wichtigsten Änderungen betreffen Vermögensprüfung, Sanktionen und Mitwirkungspflichten.',
    sections: [
      { title: 'Vermögensprüfung ab dem ersten Tag', content: 'Die bisherige Karenzzeit beim Bürgergeld sah einen Schonbetrag von <strong>40.000 €</strong> für die erste Person und <strong>15.000 €</strong> für jede weitere Person vor — in den ersten 12 Monaten. Diese Karenzzeit entfällt komplett. Ab Juli 2026 wird das Vermögen sofort geprüft. Es gilt nur noch das reguläre Schonvermögen von <strong>15.000 € pro Person</strong>.' },
      { title: 'Verschärfte Sanktionen', content: 'Bei Pflichtverletzungen — etwa der Ablehnung zumutbarer Arbeit oder dem Versäumen von Terminen — werden Leistungskürzungen strenger durchgesetzt. Die Sanktionsstufen reichen von 10 % bis zu 30 % des Regelbedarfs. Bei wiederholten Verstößen kann die Leistung zeitweise vollständig entfallen.' },
      { title: 'Strengere Mitwirkungspflichten', content: 'Zumutbare Arbeitsangebote müssen schneller angenommen werden. Der Vermittlungsvorrang wird gestärkt: Erwerbsfähige Leistungsberechtigte sollen vorrangig in den Arbeitsmarkt integriert werden. Weiterbildungsmaßnahmen bleiben möglich, aber die Anforderungen an die Eigeninitiative steigen.' },
      { title: 'Was bleibt gleich?', content: 'Die <strong>Regelsätze</strong> bleiben 2026 unverändert: 563 € für Alleinstehende, 506 € für Partner, 471 € für Jugendliche (14-17), 390 € für Kinder (6-13) und 357 € für Kinder (0-5). Auch die Freibetragsregelungen beim Hinzuverdienst bleiben bestehen. Die Kosten der Unterkunft werden weiterhin in angemessener Höhe übernommen.' },
    ],
    relatedRechner: 'buergergeld-rechner',
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'Kindergeld-Anrechnung', content: 'Bei <strong>minderjährigen Kindern</strong> wird das hälftige Kindergeld (129,50 €) vom Tabellenbetrag abgezogen — den Zahlbetrag zahlt der unterhaltspflichtige Elternteil. Bei <strong>volljährigen Kindern</strong> wird das volle Kindergeld (259 €) angerechnet, da es direkt an das Kind geht.' },
